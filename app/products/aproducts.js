...
let mproducts= [
  {
    ...
    {id:1,
        ...
        name:"سيارة - 2",
        price:"5-7 Omr",
        animationn:'/products/model/Acar2',
        staticc:'/products/model/car2',
        no:1
    }]
        ...
        let mproducts1= [{id:2,
          ...
          name:"سيارة - 3",
          price:"5-7 Omr",
          animationn:'/products/model/Acar3',
          staticc:'/products/model/car3',
          no:2
      },
      {id:3,
          ...
          name:"سيارة - 4",
          price:"5-7 Omr",
          animationn:'/products/model/Acar4',
          staticc:'/products/model/car4',
          no:3
      }]
        let mproducts2= [{id:4,
          ...
          name:"سيارة - 5",
          price:"5-7 Omr",
          animationn:'/products/model/Acar5',
          staticc:'/products/model/car5',
          no:4
      },
      {id:5,
          ...
          name:"سيارة - 6",
          price:"5-7 Omr",
          animationn:'/products/model/Acar6',
          staticc:'/products/model/car6',
          no:5
      }]
        let mproducts3= [{id:6,
          ...
          name:"طيارة - 1",
          price:"5-7 Omr",
          animationn:'/products/model/AAirp1',
          staticc:'/products/model/Airp1',
          no:6
      },
      {id:7,
          ...
          name:"طيارة - 2",
          price:"5-7 Omr",
          animationn:'/products/model/AAirp2',
          staticc:'/products/model/Airp2',
          no:7
      }]
        let mproducts4= [{id:8,
          ...
          name:"طيارة - 3",
          price:"5-7 Omr",
          animationn:'/products/model/AAirp3',
          staticc:'/products/model/Airp3',
          no:8
      },
      {id:9,
          ...
          name:"صاروخ - 1",
          price:"5-7 Omr",
          animationn:'/products/model/ARoc1',
          staticc:'/products/model/Roc1',
          no:9
      }]
    ...
    {id:11,
      ...
      let mproducts6= [
        {id:10,
          ...
          name:"سمكة",
          price:"5-7 Omr",
          animationn:'/products/model/Afish',
          staticc:'/products/model/fish',
          no:10
      }
      ]
let products= [
...
export default function Productss() {
    ...
    const isDesktopOrLaptop = useMediaQuery({
      ...
      let mproductslist = mproducts.map((product) => { 
        ...
        // <Link key={product.id} href={`/products/${product.id}`}>
          <button style={{background:'rgb(255, 255, 255, 0)', border:'0', width:'43vw', height:'40vh', marginTop:65, marginBottom:'-10%', marginLeft:'10%'}}><h3 className="cairo" style={{background:'rgba(0, 0, 20, 0.4)',WebkitTextStroke: '.3  px black' , color:'white',borderRadius:'25px',fontSize:"15px", height:'33vh',width:'40vw',textAlign:'center',lineHeight:2, paddingBottom:'1vh', paddingTop:'.0vh', zIndex:'1'}}><img src={product.image} alt='' style={{width:'40vw', height:'23vh',objectFit:'contain', marginBottom:'-29%'}}></img>{product.name} <br></br><a style={{color:'darkcyan'}} href={`${product.staticc}`}>المجسم - 5 ريال</a> <br></br>
  ...
  let mproductslist5 = mproducts5.map((product) => { 
    return(
    // <Link key={product.id} href={`/products/${product.id}`}>
      <button style={{background:'rgb(255, 255, 255, 0)', border:'0', width:'43vw', height:'40vh', marginTop:65, marginBottom:'-10%', marginLeft:'10%'}}><h3 className="cairo" style={{background:'rgba(0, 0, 20, 0.4)',WebkitTextStroke: '.3  px black' , color:'white',borderRadius:'25px',fontSize:"16px", height:'33vh',width:'40vw',textAlign:'center',lineHeight:2, paddingBottom:'0vh', paddingTop:'.0vh', zIndex:'1'}}><img src={product.image} alt='' style={{width:'40vw', height:'23vh',objectFit:'contain', marginBottom:'-29%'}}></img>{product.name} <br></br><a style={{color:'darkcyan'}} href={`${product.staticc}`}>المجسم - 5 ريال</a></h3>
      </button>
)})
let mproductslist6 = mproducts6.map((product) => { 
  return(
  // <Link key={product.id} href={`/products/${product.id}`}>
    <button style={{background:'rgb(255, 255, 255, 0)', border:'0', width:'43vw', height:'40vh', marginTop:65, marginBottom:'-10%', marginLeft:'3%'}}><h3 className="cairo" style={{background:'rgba(0, 0, 20, 0.4)',WebkitTextStroke: '.3  px black' , color:'white',borderRadius:'25px',fontSize:"15px", height:'33vh',width:'40vw',textAlign:'center',lineHeight:2, paddingBottom:'0vh', paddingTop:'.0vh', zIndex:'1'}}><img src={product.image} alt='' style={{width:'40vw', height:'23vh',objectFit:'contain', marginBottom:'-29%'}}></img>{product.name} <br></br><a style={{color:'darkcyan'}} href={`${product.staticc}`}>المجسم - 5 ريال</a> <br></br>
    <a style={{color:'darkcyan'}} href={`${product.animationn}`}>المجسم مع الحركة - 7 ريال</a></h3>
    </button>
)})
