...
export default function ContactForm() {
  const options = {
    ...
    return (
        <div style={{background: 'rgb(30, 20, 50)', width: "100%", paddingBottom:'10.5%', zIndex:0}}>
            <AResponsiveAppBar></AResponsiveAppBar>
            {isDesktopOrLaptop && <iframe style={{ display: "block", marginLeft: "auto", marginRight: "auto", paddingTop:'10%'}} width="560" height="315" src="https://www.youtube.com/embed/NxooI1oT6yc?si=6_dv50QQvV4QxrRq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>}
            {isTabletOrMobile && <iframe style={{ display: "block", marginLeft: "auto", marginRight: "auto", paddingTop:'20%'}} width="260" height="150" src="https://www.youtube.com/embed/NxooI1oT6yc?si=6_dv50QQvV4QxrRq" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>}
            <div style={{display:'flex', justifyContent:'space-around'}}>
                {isDesktopOrLaptop &&<div>
                    <div style={{marginTop:'10vh', display:'flex', justifyContent:'space-around', backgroundColor:'rgba(78, 53, 36, 0.5)', padding:'5vh',paddingTop:'8vh',paddingBottom:'13vh', borderRadius:'1%', direction:'rtl'}}>
                    <img src="https://drive.google.com/thumbnail?id=1vv-6WvJ2gX1sTkPDtDUkzzhg5YQz4e1g" style={{height:'27vh', marginRight:'3vw', marginLeft:'3vw', marginTop:'2vh'}}></img>
                    <div style={{marginLeft:'5vw'}}>
                        <h2 className="cairo" style={{color:'white', textAlign:'center'}}>اطلب المجسم</h2>
                        <br></br>
                        <form onSubmit={handleSubmit} >
                            <div style={{display:'flex', justifyContent:'center'}}>
                                <input id='Prod' type="hidden" name="Prod" value="سيارة 2 - مع الحركة" style={{marginLeft:'3vw', height:'2.5vh'}}></input>
              ...
              {isTabletOrMobile && <div> <div style={{marginTop:'10vh', backgroundColor:'rgba(78, 53, 36, 0.5)', padding:'5vh',paddingTop:'3vh',paddingBottom:'3vh', borderRadius:'1%'}}>
                    <img src="https://drive.google.com/thumbnail?id=1vv-6WvJ2gX1sTkPDtDUkzzhg5YQz4e1g" style={{marginLeft: "auto", marginRight: "auto",height:'18vh', display:'block'}}></img>
