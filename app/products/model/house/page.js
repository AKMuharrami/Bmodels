        ...
        <div style={{background: 'rgb(30, 20, 50)', width: "100%", paddingBottom:'10.5%', zIndex:0, height:'100%'}}>
            ...
            <div style={{display:'flex', justifyContent:'space-around'}}>
                {isDesktopOrLaptop &&<div>
                    ...
                    <img src="https://drive.google.com/thumbnail?id=1nHXS2Fc0DnOfyDwv_UFRnsryVT8VpoFt" style={{height:'27vh', marginRight:'3vw', marginLeft:'3vw', marginTop:'2vh'}}></img>
                    <div style={{marginLeft:'5vw'}}>
                        <h2 className="cairo" style={{color:'white', textAlign:'center'}}>اطلب المجسم</h2>
                        <br></br>
                        <form onSubmit={handleSubmit} >
                            <div style={{display:'flex', justifyContent:'center'}}>
                                <input id='Prod' type="hidden" name="Prod" value="البيت"  style={{marginLeft:'3vw', height:'2.5vh'}}></input>
              ...
              {isTabletOrMobile && <div> <div style={{marginTop:'13vh', backgroundColor:'rgba(78, 53, 36, 0.5)', padding:'5vh',paddingTop:'3vh',paddingBottom:'3vh', borderRadius:'1%'}}>
                    <img src="https://drive.google.com/thumbnail?id=1nHXS2Fc0DnOfyDwv_UFRnsryVT8VpoFt" style={{marginLeft: "auto", marginRight: "auto",height:'18vh', display:'block'}}></img>
